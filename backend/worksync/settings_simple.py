"""
Simple Django settings for WorkSync project - Python 3.13 compatible
"""
...
LANGUAGE_CODE = 'en-us'
# FORCE LOS ANGELES TIME EVERYWHERE - the company operates in PST only
TIME_ZONE = 'America/Los_Angeles'
USE_I18N = True
# Keep timezone support - Django stores as UTC in DB, converts using TIME_ZONE
USE_TZ = True
...
API_KEYS = {
    'BR_DRIVER_APP': 'test-api-key-12345',
}
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@worksync.com')
